...
PKG_DEPENDS_TARGET="libogg libvorbis"
PKG_SECTION="audio"
PKG_SHORTDESC="Renders mod music files as raw audio data, for playing or conversion."
PKG_LONGDESC="Libopenmpt renders mod music files as raw audio data, for playing or conversion."

PKG_IS_ADDON="no"
PKG_AUTORECONF="no"

PKG_CONFIGURE_OPTS_TARGET="--without-mpg123 \
                           --with-vorbis \
                           --with-vorbisfile \
                           --without-pulseaudio \
                           --without-portaudio \
